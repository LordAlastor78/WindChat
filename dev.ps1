...
Write-Host "🌬️  WindChat - Dev Launch" -ForegroundColor Green
Write-Host "================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host ""
Write-Host "📋 Qué se abrirá:" -ForegroundColor Cyan
...
Write-Host "✅ WindChat en desarrollo. Abre las ventanas que se abrieron..." -ForegroundColor Green
Write-Host ""
