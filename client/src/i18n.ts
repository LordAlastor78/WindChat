...
const translations: Record<Lang, Record<string, string>> = {
  es: {
    ...
    shareLinkButton: 'Crear enlace',
    shareLinkButtonText: 'Crear enlace',
    shareLinkTitle: 'Enlace público',
    shareLinkSub: 'Comparte tu relay por un túnel efímero de Cloudflare. El cifrado E2EE sigue intacto.',
    shareLinkIdle: 'Pulsa “Crear enlace” para generar la URL.',
    shareLinkUrlLabel: 'URL del túnel',
    shareLinkCreate: 'Crear enlace',
    shareLinkStop: 'Detener enlace',
  ...
  en: {
    ...
    shareLinkButton: 'Create link',
    shareLinkButtonText: 'Create link',
    shareLinkTitle: 'Public link',
    shareLinkSub: 'Share your relay through an ephemeral Cloudflare tunnel. E2EE encryption stays intact.',
    shareLinkIdle: 'Press “Create link” to generate the URL.',
    shareLinkUrlLabel: 'Tunnel URL',
    shareLinkCreate: 'Create link',
    shareLinkStop: 'Stop link',
